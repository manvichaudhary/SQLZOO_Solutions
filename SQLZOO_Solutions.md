...
JOIN route b
ON a.num = b.num
WHERE a.stop IN (SELECT id FROM stops WHERE name = 'Craiglockhart') AND b.stop IN (SELECT id FROM stops WHERE name = 'Tollcross')
...
10.
--Problem with solution for this question 10
